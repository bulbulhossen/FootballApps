package com.example.appsd.adscourse.utils;
    ...
    public static String getLeague(Resources res, int leagueId)
    {
        switch (leagueId) {
            ...
            case CHAMPIONS_LEAGUE :
                return res.getString(R.string.champions);
            ...
            case LIGUE :
                return res.getString(R.string.ligue);
            case PRIMERA_LIGA :
            ...
            default: return res.getString(R.string.error_unknown_league);
        }
    }
